...
alter table public.trade_decisions add column if not exists post_image_url text not null default '';
alter table public.trade_decisions add column if not exists result_r numeric not null default 0;
