...
function runtimeEnvironment() {
  return {
    ...
    OPENAI_JARVIS_DEEP_MODEL: process.env.OPENAI_JARVIS_DEEP_MODEL,
    OPENAI_JARVIS_FAST_MODEL: process.env.OPENAI_JARVIS_FAST_MODEL,
    OPENAI_JARVIS_VOICE_MODEL: process.env.OPENAI_JARVIS_VOICE_MODEL,
    OPENAI_JARVIS_VOICE: process.env.OPENAI_JARVIS_VOICE,
    OPENAI_JARVIS_TRANSCRIBE_MODEL: process.env.OPENAI_JARVIS_TRANSCRIBE_MODEL,
